        ...
        <div className="category_card">
          <div className="category_card_content">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_1532_868)">
                <path
        ...
        <div className="category_card">
          <div className="category_card_content">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_1532_613)">
                <path
        ...
        <div className="category_card">
          <div className="category_card_content">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_1532_644)">
                <path
        ...
        <div className="category_card">
          <div className="category_card_content">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_1532_809)">
                <path
