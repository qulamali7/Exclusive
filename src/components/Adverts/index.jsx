                ...
                <div className="adverts_container">
                    <div className="adverts_cards">
                        <div className="adverts_card">
                            <div className="adverts_card_icon">
                                <div className="adverts_card_icon_border">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
                                        <g clip-path="url(#clip0_1532_335)">
                            ...
                            <div className="adverts_card_icon">
                                <div className="adverts_card_icon_border">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                                        <g clip-path="url(#clip0_1532_352)">
